...
## 1. Purpose
This document enforces strict "Clean Code" and "SOLID" engineering principles for all software development within the Confluence Trade Crew project. Every agent, tool, or AI assistant (e.g., Claude Code, VS Code Agents) MUST evaluate their code against these rules BEFORE writing or modifying any file.
