...
TASK_DESCRIPTION = (
    ...
    "- Volume spike status\n\n"
    "COMPUTED LEVELS (from tool output):\n"
    "- Bullish Breakout Above: <bullish_breakout_above>\n"
    "- Bearish Breakdown Below: <bearish_breakdown_below>\n"
    "- Confirmation Above: <confirmation_above>\n"
    "- Confirmation Below: <confirmation_below>\n\n"
