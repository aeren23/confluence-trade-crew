...
namespace Confluence.Infrastructure.Migrations
{
    ...
    [Migration("20260629121242_AddSnapshotsAndExecutionQuality")]
    partial class AddSnapshotsAndExecutionQuality
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Confluence.Domain.Entities.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Symbol = "BTC/USDT",
                            BaseAsset = "BTC",
                            CreatedAt = new DateTime(2026, 6, 29, 12, 12, 42, 99, DateTimeKind.Utc).AddTicks(8175),
                            IsActive = true,
                            IsFavorite = true,
                            QuoteAsset = "USDT"
                        },
                        new
                        {
                            Symbol = "ETH/USDT",
                            BaseAsset = "ETH",
                            CreatedAt = new DateTime(2026, 6, 29, 12, 12, 42, 99, DateTimeKind.Utc).AddTicks(8178),
                            IsActive = true,
                            IsFavorite = false,
                            QuoteAsset = "USDT"
                        });
            ...
            modelBuilder.Entity("Confluence.Domain.Entities.UserSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RiskProfile = "moderate",
                            UpdatedAt = new DateTime(2026, 6, 29, 12, 12, 42, 99, DateTimeKind.Utc).AddTicks(8331)
                        });
                });
