...
namespace Confluence.Infrastructure.Migrations
{
    ...
    [Migration("20260622103637_CreateStrategyTemplatesTable")]
    partial class CreateStrategyTemplatesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Confluence.Domain.Entities.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Symbol = "BTC/USDT",
                            BaseAsset = "BTC",
                            CreatedAt = new DateTime(2026, 6, 22, 10, 36, 36, 404, DateTimeKind.Utc).AddTicks(8380),
                            IsActive = true,
                            IsFavorite = true,
                            QuoteAsset = "USDT"
                        },
                        new
                        {
                            Symbol = "ETH/USDT",
                            BaseAsset = "ETH",
                            CreatedAt = new DateTime(2026, 6, 22, 10, 36, 36, 404, DateTimeKind.Utc).AddTicks(8382),
                            IsActive = true,
                            IsFavorite = false,
                            QuoteAsset = "USDT"
                        });
            ...
            modelBuilder.Entity("Confluence.Domain.Entities.UserSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RiskProfile = "moderate",
                            UpdatedAt = new DateTime(2026, 6, 22, 10, 36, 36, 404, DateTimeKind.Utc).AddTicks(8529)
                        });
                });
