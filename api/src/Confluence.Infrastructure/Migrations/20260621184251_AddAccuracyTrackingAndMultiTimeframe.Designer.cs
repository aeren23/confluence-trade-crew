...
namespace Confluence.Infrastructure.Migrations
{
    ...
    [Migration("20260621184251_AddAccuracyTrackingAndMultiTimeframe")]
    partial class AddAccuracyTrackingAndMultiTimeframe
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Confluence.Domain.Entities.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Symbol = "BTC/USDT",
                            BaseAsset = "BTC",
                            CreatedAt = new DateTime(2026, 6, 21, 18, 42, 50, 257, DateTimeKind.Utc).AddTicks(3227),
                            IsActive = true,
                            IsFavorite = true,
                            QuoteAsset = "USDT"
                        },
                        new
                        {
                            Symbol = "ETH/USDT",
                            BaseAsset = "ETH",
                            CreatedAt = new DateTime(2026, 6, 21, 18, 42, 50, 257, DateTimeKind.Utc).AddTicks(3230),
                            IsActive = true,
                            IsFavorite = false,
                            QuoteAsset = "USDT"
                        });
            ...
            modelBuilder.Entity("Confluence.Domain.Entities.UserSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2026, 6, 21, 18, 42, 50, 257, DateTimeKind.Utc).AddTicks(3398)
                        });
                });
