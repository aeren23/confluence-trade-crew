...
namespace Confluence.Infrastructure.Migrations
{
    ...
    [Migration("20260715212451_AddParentTradeId")]
    partial class AddParentTradeId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Confluence.Domain.Entities.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Symbol = "BTC/USDT",
                            BaseAsset = "BTC",
                            CreatedAt = new DateTime(2026, 7, 15, 21, 24, 50, 38, DateTimeKind.Utc).AddTicks(1767),
                            IsActive = true,
                            IsFavorite = true,
                            QuoteAsset = "USDT"
                        },
                        new
                        {
                            Symbol = "ETH/USDT",
                            BaseAsset = "ETH",
                            CreatedAt = new DateTime(2026, 7, 15, 21, 24, 50, 38, DateTimeKind.Utc).AddTicks(1772),
                            IsActive = true,
                            IsFavorite = false,
                            QuoteAsset = "USDT"
                        });
            ...
            modelBuilder.Entity("Confluence.Domain.Entities.UserSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RiskProfile = "moderate",
                            UpdatedAt = new DateTime(2026, 7, 15, 21, 24, 50, 38, DateTimeKind.Utc).AddTicks(3185)
                        });
                });
