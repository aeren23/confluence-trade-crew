...
namespace Confluence.Infrastructure.Migrations
{
    ...
    [Migration("20260629113026_AddTradeReviewsTable")]
    partial class AddTradeReviewsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Confluence.Domain.Entities.Pair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Symbol = "BTC/USDT",
                            BaseAsset = "BTC",
                            CreatedAt = new DateTime(2026, 6, 29, 11, 30, 25, 18, DateTimeKind.Utc).AddTicks(2654),
                            IsActive = true,
                            IsFavorite = true,
                            QuoteAsset = "USDT"
                        },
                        new
                        {
                            Symbol = "ETH/USDT",
                            BaseAsset = "ETH",
                            CreatedAt = new DateTime(2026, 6, 29, 11, 30, 25, 18, DateTimeKind.Utc).AddTicks(2657),
                            IsActive = true,
                            IsFavorite = false,
                            QuoteAsset = "USDT"
                        });
            ...
            modelBuilder.Entity("Confluence.Domain.Entities.UserSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RiskProfile = "moderate",
                            UpdatedAt = new DateTime(2026, 6, 29, 11, 30, 25, 18, DateTimeKind.Utc).AddTicks(2833)
                        });
                });
